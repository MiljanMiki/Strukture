...
public:
	...
	inline BSTNodeInt* getRoot() { return root; };
	...
	BSTNodeInt* nadjiRazlikuVisina(BSTNodeInt* start, int* maxRazlika, BSTNodeInt* maxNode);

	int modifikovanBFS(BSTNodeInt* start);
